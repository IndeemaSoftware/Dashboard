...
var _exampleCode = __webpack_require__(307);
...
var App = function App() {
  var formattedData = (0, _keys2.default)(data).reduce(function (arr, from) {
    var weights = data[from];
    return arr.concat((0, _keys2.default)(weights).map(function (to) {
      return [from, to, weights[to]];
    }));
  }, []);
  ...
  return _react2.default.createElement(
    ...
    _react2.default.createElement(
      ...
      _react2.default.createElement(_reactJsxHighcharts.XAxis, { type: 'category' }),
      _react2.default.createElement(
        _reactJsxHighcharts.YAxis,
        null,
        _react2.default.createElement(_reactJsxHighcharts.SankeySeries, { name: 'Sankey demo series', data: formattedData, keys: ['from', 'to', 'weight'] })
      ),
